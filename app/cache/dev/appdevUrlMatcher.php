...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello2') && preg_match('#^/hello2/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Acme\\Bundle\\TestBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'AcmeTestBundle_homepage'));
        }
